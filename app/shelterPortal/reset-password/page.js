...
export default function ResetPasswordPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      logger.dev('Password reset attempt:', sanitizeData({ email: formData.email }));
      
      const response = await fetch('/api/shelterAdmin/reset-password', {
        method: 'POST',
      ...
      logger.error(error, 'Reset Password Page - handleSubmit');
          ...
          <div className="p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={`w-full px-5 py-3 pl-12 border rounded-xl focus:outline-none focus:ring-2 focus:ring-[#3B82C4] focus:border-[#1A5276] transition-all duration-300 ${errors.resetCode ? 'border-red-300 bg-red-50' : 'border-gray-200'} bg-gray-50`}
                ...
                <div className="relative">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className={`w-full px-5 py-3 pl-12 border rounded-xl focus:outline-none transition-all duration-300 ${errors.newPassword ? 'border-red-300 bg-red-50' : 'border-gray-200'} bg-gray-50 relative z-10`}
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={`w-full px-5 py-3 pl-12 border rounded-xl focus:outline-none focus:ring-2 focus:ring-[#3B82C4] focus:border-[#1A5276] transition-all duration-300 ${errors.confirmPassword ? 'border-red-300 bg-red-50' : 'border-gray-200'} bg-gray-50`}
              ...
              <button
                type="submit"
                disabled={isLoading}
                className={`w-full py-3 px-4 bg-gradient-to-r from-[#3B82C4] to-[#1A5276] text-white font-medium rounded-xl transition-all duration-300 hover:from-[#1F6A91] hover:to-[#0C374A] ${isLoading ? 'opacity-70 cursor-not-allowed' : ''} transform hover:-translate-y-0.5`}
              >
                {isLoading ? (
